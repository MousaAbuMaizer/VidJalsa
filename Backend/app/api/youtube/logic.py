...
def fetch_search_results(youtube, topic: str, max_results: int) -> list:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to fetch search results from YouTube.")
...
def extract_video_ids(search_response: dict) -> list:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to extract video IDs from search results.")
...
def filter_videos(video_ids: list, video_details_map: dict, search_response: dict, max_results: int) -> list:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to filter videos.")
...
def format_video_info(video_item: dict) -> dict:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to format video information.")
